...
Queries used for Tableau Project from the Covid Data
...
Select Location, Population,CAST(date AS DATETIME) as date, MAX(total_cases) as HighestInfectionCount,  MAX((CAST(total_cases AS FLOAT)/ population))*100 as PercentPopulationInfected
From PortfolioProject..CovidDeaths
--Where location like '%states%'
